...
const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  { q: "what are the recommended speakers for earvana audio?",
    a: "the earvana soundscapes sound great on any playback system, but specifically, earbuds/airpods/headphones will provide the most effective experience for tinnitus sufferers. when playing through external speakers, the most profound immersive realism happens when your stereo speakers can be physically separated; the wider the better.\n\nBEST:  in-ear/over-ear. (even better with noise cancellation).\n\nGREAT:  quality full-range external speakers, separated by 3+ feet.\n\nGOOD:  laptop speakers\n\nDECENT:  any device where the speakers are close together (i.e., boombox or built-in phone/tablet speakers)." },
  { q: "will this work over bluetooth wireless?",
    a: "yes. the earvana soundscapes work in both wired and wireless mode.\n\nconnect your airpods or wireless buds/phones before pressing play. audio routes automatically through your device's active output. clicking the speaker icon on the lower left of your screen can give you output options." },
  { q: "earvana is playing but I don't hear any audio.",
    a: "depending on your device, there are different behaviors to set/change audio output. often your device will be defaulting to a different bluetooth speaker nearby. stop the earvana playback and manage your output routing through your device's settings pages. then restart the earvana playback." },
