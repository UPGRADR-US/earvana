...
function Home() {
  ...
  return (
    <div className="relative flex flex-col w-full overflow-hidden select-none"
      ...
      <img src={img("evTR_bg_1784061003811.png")} alt=""
      ...
      {!settingsOpen && !diagOpen && (
        <>
          ...
          <div className="relative z-10 flex-shrink-0 w-full">
            <img src={img("TopBanner5_1784061003811.png")} alt="tinnitus relief by earvana with AUDIO-MERSIVE technology"
                    ...
                    <div style={{
                      ...
                      {isOn && activeFreq !== null ? (
                        <>
                          ...
                          <span style={{ fontFamily: "'Figtree', sans-serif", fontWeight: 700, color: "#ffcc00", fontSize: "clamp(10px,2.4cqw,13px)", letterSpacing: "0.04em", lineHeight: 1.3, transform: "scaleY(0.9)", transformOrigin: "center center", display: "inline-block" }}>
                            {fmtFreq(activeFreq)}
                          </span>
                        </>
                      ) : null}
