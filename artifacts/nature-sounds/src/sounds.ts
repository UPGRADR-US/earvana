...
export const CATEGORIES: SoundCategory[] = [
  {
    ...
    tracks: [
      ...
      { id: "ocean_waterlaps_cove_cine", name: "ocean: waterlaps cove cine", file: "sounds/ocean-WaterlapsCoveCine.mp3", icon: "Waves", defaultVolume: 0.561 },
    ],
  },
  {
    id: "rains",
    ...
    tracks: [
      ...
      { id: "rain_quiet_storm",           name: "rain: quiet storm",           file: "sounds/rain-QuietStorm.mp3",           icon: "CloudLightning", defaultVolume: 0.354 },
  ...
  },
  {
    ...
    tracks: [
      ...
      { id: "garden_morning_melody",    name: "garden: morning melody",    file: "sounds/garden-MorningMelody.mp3",    icon: "Leaf" },
    ],
  },
  {
    id: "fire",
  ...
  },
  {
    ...
    tracks: [
      ...
      { id: "noise_white_static",  name: "noise: white-static", file: "sounds/noise-WhiteStatic.mp3", icon: "Radio", crossfadeDuration: 2 },
      { id: "noise_pink_wave",     name: "noise: pink wave",    file: "sounds/noise-PinkWave.mp3",    icon: "Radio" },
      { id: "noise_pink_static",   name: "noise: pink-static",  file: "sounds/noise-PinkStatic.mp3",  icon: "Radio", crossfadeDuration: 2 },
      { id: "noise_green_wave",    name: "noise: green wave",   file: "sounds/noise-GreenWave.mp3",   icon: "Radio" },
      { id: "noise_green_static",  name: "noise: green-static", file: "sounds/noise-GreenStatic.mp3", icon: "Radio", crossfadeDuration: 2 },
      { id: "noise_brown_wave",    name: "noise: brown wave",   file: "sounds/noise-BrownWave.mp3",   icon: "Radio" },
      { id: "noise_brown_static",  name: "noise: brown-static", file: "sounds/noise-BrownStatic.mp3",  icon: "Radio", crossfadeDuration: 2 },
      { id: "noise_black_wave",    name: "noise: black wave",   file: "sounds/noise-BlackWave.mp3",   icon: "Radio" },
    ],
  },
];
